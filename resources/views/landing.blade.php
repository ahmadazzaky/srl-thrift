...
<html lang="en" id="home">
  ...
  <body class="mt-5">
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light my-bg-warning">
      <div class="container">
        <a class="navbar-brand font-bold" href="#home">SRL THRIFT</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="rounded-circle" height="30" src="/storage/{{ auth()->user()->photo }}" alt="Profile image">
              </a>
              <ul class="dropdown-menu">
    ...
    <div class="card text-bg-dark rounded-0 card-hero py-5">
      <div class="container py-5">
        ...
        <h1 class="card-title text-uppercase d-flex justify-content-center" style="font-size: 60px">SRL THRIFT</h1>
        <hr class="hr-hero-1 d-flex justify-content-center"><hr class="hr-hero-2 d-flex justify-content-center">
        <p class="card-text text-capitalize text-white mb-0 d-flex justify-content-center" style="font-size: 20px">tunjang outfit dengan biaya irit</p>
      ...
      <div class="container">
        <div class="row justify-content-center gx-5">
          <div class="col-4 col-md-2">
            <img src="/assets/images/hollisterlogo.png" alt="foto brand" class="w-100">
          </div>
          <div class="col-4 col-md-2">
            <img src="/assets/images/frj-jeans-logo.png" alt="foto brand" class="w-100">
          </div>
          <div class="col-4 col-md-2">
            <img src="/assets/images/ray-ban-logo.png" alt="foto brand" class="w-100">
          </div>
          <div class="col-4 col-md-2">
            <img src="/assets/images/shane-jeans-logo.jpg" alt="foto brand" class="w-100">
          </div>
          <div class="col-4 col-md-2">
            <img src="/assets/images/osiris-logo.jpg" alt="foto brand" class="w-100">
          </div>
        </div>
        <hr class="my-4">
        <div class="row">
          <div class="col-md-6">
            ...
            <ul class="list-unstyled">
              ...
              <li class="mb-2">
                ...
                Pesawaran Residence Blok H No. 10
              </li>
              <li class="mb-2">
                <img src="/assets/images/wa.svg" alt="address" height="20" class="me-2">
                <a href="https://wa.me/62895600810108" class="text-decoration-none text-black" target="_blank">wa.me/62895600810108</a>
              </li>
              <li class="mb-2">
                <img src="/assets/images/ig.svg" alt="address" height="20" class="me-2">
                <a href="https://www.instagram.com/srl.thrift/" class="text-decoration-none text-black" target="_blank">Instagram SRL Thrift</a>
              </li>
            </ul>
          </div>
          <div class="col-md-6">
            <h2 class="text-uppercase font-bold h6">map</h2>
            <iframe style="height:160px";style="width:600px";class="w-100 rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.2834729163174!2d105.18724987511166!3d-5.373673194605169!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e40d0211f2e13b3%3A0x9a4160df24616ca4!2sPerum%20Pesawaran%20Residence%20(PPR)!5e0!3m2!1sid!2sid!4v1693401432838!5m2!1sid!2sid" width="630" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
